/******************************************************************************
 * @file     vio_STM32F072B-DISCO.c
 * @brief    Virtual I/O implementation for board STM32F072B-DISCO
 * @version  V1.0.0
...
/*! \page vio_STM32F072B-DISCO Physical I/O Mapping
...
| vioLED0       | vioSignalOut.0 | LED red     (LD3)    | PC6
| vioLED1       | vioSignalOut.1 | LED green   (LD5)    | PC9
| vioLED2       | vioSignalOut.2 | LED blue    (LD6)    | PC7
| vioLED3       | vioSignalOut.3 | LED orange  (LD4)    | PC8
...
//  signal,     pin,                   pull resistor,      active state
  ...
  { vioLED1,    GPIO_PIN_ID_PORTC(9),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED2,    GPIO_PIN_ID_PORTC(7),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED3,    GPIO_PIN_ID_PORTC(8),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH }
};
#endif
